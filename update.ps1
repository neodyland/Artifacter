...
rm dynamic-assets/hsr/characters.json
curl.exe https://github.com/EnkaNetwork/API-docs/raw/master/store/hsr/honker_characters.json -o dynamic-assets/hsr/characters.json -L
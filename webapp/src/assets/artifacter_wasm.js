...
function __wbg_adapter_28(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1e9e4ca0e3075a47(arg0, arg1, addHeapObject(arg2));
}
...
* @returns {Promise<any>}
*/
export function w_load() {
    const ret = wasm.w_load();
...
* @returns {Promise<any>}
*/
export function get_profile(uid) {
    const ret = wasm.get_profile(uid);
    return takeObject(ret);
}
...
* @returns {Promise<any>}
*/
export function generate(uid, cid, lang, format, counter) {
    const ptr0 = passStringToWasm0(lang, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(format, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(counter, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.generate(uid, cid, ptr0, len0, ptr1, len1, ptr2, len2);
    return takeObject(ret);
}
...
function __wbg_adapter_83(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h274a6b6f781367d9(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('artifacter_wasm_bg.wasm', import.meta.url);
    }
    const imports = getImports();

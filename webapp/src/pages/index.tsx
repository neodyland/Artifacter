...
export function IndexPage() {
  ...
  return (
    <div className="relative overflow-hidden">
      <div className="mx-auto h-screen max-h-screen max-w-screen-2xl px-8 pt-32 md:px-8 lg:px-20 lg:pt-0 flex lg:flex-row">
        <div className="lg:flex-1">
          <div className="flex h-full flex-col justify-center items-center lg:items-stretch">
            <h1 className="bg-clip-text my-6 font-primary font-bold text-6xl tracking-wider text-white md:text-7xl lg:py-2 lg:text-[5rem] 2xl:text-8xl text-center lg:text-start">
              Generate Build Card
            </h1>
            <p
              className={`${
              ...
              } py-2 tracking-wider text-white text-center lg:text-start`}
            >
              {locale({
            ...
            <div className="pt-6 w-full">
              <motion.div
                className="relative block lg:w-3/4"
        ...
        <div className="flex-1">
          <div className="absolute top-0 left-[-50%] -z-10 w-[200%] lg:left-auto lg:right-0 lg:w-[80%] xl:w-[85%] 2xl:w-[75%] ">
            <div className="relative h-[calc(100%+20px)] w-full before:absolute before:inset-y-[-10px] before:inset-x-0 before:z-10 before:lg:bg-image-cover-lg before:bg-image-cover before:content-[''] lg:w-[calc(100%+2px)] lg:before:inset-x-[-1px]">
              <img
                src={top}
                className="z-0 mt-[-10px] mr-[-8px] lg:w-full lg:block h-full w-auto"
                alt="top"
              ></img>
            </div>
          </div>
